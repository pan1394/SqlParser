...
public class ExcelLogicProgress {
	...
	public final static int maxWith = 17;
	...
	private boolean createNewRow = true;
	...
	public void setCreateNewRow(boolean createNewRow) {
		this.createNewRow = createNewRow;
	}

	public int getRowNum() {
		return this.row - this.initRowNum + 1;
	}
	...
	public void decreaseDepth() {
		...
		// row--;
		System.out.println(
				String.format("current unit depth column: %d, row: %d, rownum: %d", getCol(), getRow(), getRowNum()));
	}
