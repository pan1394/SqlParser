...
public class EditorRuler extends JComponent implements MouseMotionListener, DropTargetListener {
	...
	/**
	 * Internal constant used to describe the screen resolution (DPI). Default is
	 * 72.
	 */
	...
	/**
	 * Specified that start and length of the active region, ie the region to paint
	 * with the background border. This is used for example to indicate the
	 * printable region of a graph.
	 */
	...
	/**
	 * Updates the local variables used for painting based on the current scale and
	 * unit system.
	 */
