...
public class BDataCopyNode extends BNode implements ILogicCell {

	/**
	 * 
	 */
	private static final long serialVersionUID = 338815080916386700L;

	private DataCopyLogic logic;

	public BDataCopyNode() {
	...
	public void setLogic(DataCopyLogic logic) {
		this.logic = logic;
	}
