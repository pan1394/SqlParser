...
public class EditorAboutFrame extends JDialog {
	...
	public EditorAboutFrame(Frame owner) {
		...
		// Adds title
		JLabel titleLabel = new JLabel("Bee");
		...
		JLabel subtitleLabel = new JLabel("For more information visit http://www.linkstec.com/");
		...
		content.add(new JLabel("Bee - The tool for design"));
		content.add(new JLabel("Bee Version 1.0"));
		content.add(new JLabel("Copyright (C) 2018 by linkstec. Ltd."));
	...
	/**
	 * Overrides {@link JDialog#createRootPane()} to return a root pane that hides
	 * the window when the user presses the ESCAPE key.O
	 */
