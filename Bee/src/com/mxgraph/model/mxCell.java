...
public class mxCell implements mxICell, Cloneable, Serializable {
	...
	/**
	 * Specifies whether the cell is a vertex or edge and whether it is connectable,
	 * visible and collapsed. Default values are false, false, true, true and false
	 * respectively.
	 */
	...
	/**
	 * Returns a clone of the user object. This implementation clones any XML nodes
	 * or otherwise returns the same user object instance.
	 */
