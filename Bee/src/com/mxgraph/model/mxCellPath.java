...
public class mxCellPath {
	...
	/**
	 * Defines the separator between the path components. Default is <code>.</code>.
	 */
	public static String PATH_SEPARATOR = ".";

	/**
	 * Creates the cell path for the given cell. The cell path is a concatenation of
	 * the indices of all cells on the (finite) path to the root, eg. "0.0.0.1".
	 * 
	 * @param cell
	...
	/**
	 * Compares the given cell paths and returns -1 if cp1 is smaller, 0 if cp1 is
	 * equal and 1 if cp1 is greater than cp2.
	 */
