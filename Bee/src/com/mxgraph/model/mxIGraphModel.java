...
public interface mxIGraphModel {
	 ...
	 * value of includeChildren, a deep clone is created for each cell. Connections
	 * are restored based if the corresponding cell is contained in the passed in
	 * array.
	 * 
	 * @param cells
	 ...
	 * @param style
	 *            String of the form stylename[;key=value] to specify the new cell
	 *            style.
