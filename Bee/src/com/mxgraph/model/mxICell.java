...
public interface mxICell {
	 ...
	 * updates the parent reference of the child. Returns the inserted child.
	 * 
	 * @param child
	...
	/**
	 * Removes the given child from the child array and returns it. Will remove the
	 * parent reference of the child.
	 * 
	 * @param child
