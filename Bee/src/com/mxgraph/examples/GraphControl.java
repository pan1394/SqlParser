...
public class GraphControl extends JComponent {
	...
	public GraphControl(mxGraph graph) {
		this.graph = graph;
		this.graph.getModel().addListener(mxEvent.CHANGE, new mxIEventListener() {
	...
	protected Icon createBuffer() {
		return new ImageIcon(
				mxCellRenderer.createBufferedImage(graph, null, graph.getView().getScale(), null, true, null));
	}
