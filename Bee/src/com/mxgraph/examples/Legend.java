...
public class Legend {
	...
	public static void main(String[] args) {
		...
		BufferedImage image = createBufferedImage(graph, null, 1, Color.WHITE, true, null);
		/*
	...
	public static BufferedImage createBufferedImage(mxGraph graph, Object[] cells, double scale, final Color background,
		...
		mxImageCanvas canvas = (mxImageCanvas) mxCellRenderer.drawCells(graph, cells, scale, clip, new CanvasFactory() {
			public mxICanvas createCanvas(int width, int height) {
				int border = 10;
				int dx = 0;
				int dy = 60;

				mxImageCanvas canvas = new mxImageCanvas(new mxGraphics2DCanvas(), width + dx + border,
