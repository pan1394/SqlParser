...
/**
 * The frame example uses the graph model API to programmatically create a graph
 * image to be used as a background of a JComponent.
 */
public class Frame extends JFrame {
	...
	public Frame() {
		...
		try {
			...
			mxCell v2 = (mxCell) graph.insertVertex(parent, null, "World!", 240, 150, 80, 30);
			Object e1 = graph.insertEdge(parent, null, "e1", v1, v2);

			mxCell v3 = (mxCell) graph.insertVertex(e1, null, "v3", -0.5, 0, 40, 40, "shape=triangle");
