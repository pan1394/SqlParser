...
public class JTableRenderer extends JComponent {
	...
	/**
	 * Implements an event redirector for the specified handle index, where 0 is the
	 * top right, and 1-7 are the top center, rop right, middle left, middle right,
	 * bottom left, bottom center and bottom right, respectively. Default index is 7
	 * (bottom right).
	 */
		...
		public MyTable() {
			...
			for (int i = 0; i < 30; i++) {
				...
				data[i][2] = (Math.random() > 0.5)
						? new ImageIcon(JTableRenderer.class.getResource(IMAGE_PATH + "preferences.gif"))
						: null;
