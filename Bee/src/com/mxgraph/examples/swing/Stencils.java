...
public class Stencils extends JFrame {
	...
	public Stencils() {
		...
		try {
			String filename = Stencils.class.getResource("/com/mxgraph/examples/swing/shapes.xml").getPath();
			...
			try {
				Object v1 = graph.insertVertex(parent, null, "Hello", 20, 20, 80, 30,
						"shape=or;fillColor=#ff0000;gradientColor=#ffffff;shadow=1");
				Object v2 = graph.insertVertex(parent, null, "World!", 240, 150, 80, 30,
						"shape=MOSFET_P_CH_DEP;shadow=1");
