...
public class CustomCanvas extends JFrame {
	...
	public class SwingCanvas extends mxInteractiveCanvas {
		...
		public void drawVertex(mxCellState state, String label) {
			...
			rendererPane.paintComponent(g, vertexRenderer, graphComponent, (int) (state.getX() + translate.getX()),
					(int) (state.getY() + translate.getY()), (int) state.getWidth(), (int) state.getHeight(), true);
		}
