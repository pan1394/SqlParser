...
/**
 * Defines an object that contains the constraints about how to connect one side
 * of an edge to its terminal.
 */
public class mxConnectionConstraint {
	...
	/**
	 * Boolean that specifies if the point should be projected onto the perimeter of
	 * the terminal.
	 */
	 ...
	 * 
	 * @param point
	 *            Optional mxPoint that specifies the fixed location of the point in
	 *            relative coordinates. Default is null.
	 * @param perimeter
