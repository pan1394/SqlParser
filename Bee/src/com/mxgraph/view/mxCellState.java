...
public class mxCellState extends mxRectangle {
	...
	/**
	 * Holds the current label value, including newlines which result from word
	 * wrapping.
	 */
	...
	/**
	 * Holds the absolute offset. For edges, this is the absolute coordinates of the
	 * label position. For vertices, this is the offset of the label relative to the
	 * top, left corner of the vertex.
	 */
	...
	/**
	 * Constructs a new object that represents the current state of the given cell
	...
	/**
	 * Returns the rectangle that should be used as the perimeter of the cell. This
	 * implementation adds the perimeter spacing to the rectangle defined by this
	 * cell state.
	 * 
	 ...
	 * @param isSource
	 *            Boolean that specifies if the first or last point should be
	 *            assigned.
	 */
	 ...
	 * @param source
	 *            Boolean that specifies if the source or target state should be
	 *            set.
	 */
	...
	/**
	 * Returns a clone of this state where all members are deeply cloned except the
	 * view and cell references, which are copied with no cloning to the new
	 * instance.
	 */
	public Object clone() {
