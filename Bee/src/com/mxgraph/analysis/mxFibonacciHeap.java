...
public class mxFibonacciHeap {
	 ...
	 * 
	 * @param element
	 *            the element whose node to find
	 * @param create
	 *            whether to create
	 ...
	 * 
	 * @param x
	 *            Node whose value should be decreased.
	 * @param k
	...
	/**
	 * Deletes a node from the heap given the reference to the node. The trees in
	 * the heap will be consolidated, if necessary. This operation may fail to
	 * remove the correct element if there are nodes with key value -Infinity.
	 * 
	 * <p>
	...
	/**
	 * Inserts a new data element into the heap. No heap consolidation is performed
	 * at this time, the new node is simply inserted into the root list of this
	 * heap.
	 * 
	 * <p>
	...
	/**
	 * Returns the smallest element in the heap. This smallest element is the one
	 ...
	 * heap to be consolidated, if necessary. Does not remove the data node so that
	 * the current key remains stored.
	 * 
	 * <p>
	 * Running time: O(log n) amortized
	 * </p>
	...
	/**
	 * Joins two Fibonacci heaps into a new one. No heap consolidation is performed
	 * at this time. The two root lists are simply joined together.
	 * 
	 * <p>
	 * Running time: O(1) actual
	 * </p>
	 ...
	 * 
	 * @param x
	 *            The child of y to be removed from y's child list.
	 * @param y
	 ...
	 * key value (which is used to determine the heap structure). Additional Node
	 * data should be stored in a subclass.
	 */
	public static class Node {
		...
		/**
		 * Default constructor. Initializes the right and left pointers, making this a
