...
public class mxUnionFind {
	...
	/**
	 * Returns the set that contains <code>node</code>. This implementation provides
	...
	/**
	 * Unifies the sets <code>a</code> and <code>b</code> in constant time using a
	 * union by rank on the tree size.
	 */
	...
	/**
	 * Returns true if element a and element b are not in the same set. This uses
	 * getNode and then find to determine the elements set.
	 * 
	 * @param a
