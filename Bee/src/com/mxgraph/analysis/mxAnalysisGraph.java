...
public class mxAnalysisGraph {
	 ...
	 * 
	 * @param parent
	 *            the cell whose children will be return
	 ...
	 * 
	 * @param parent
	 *            the cell whose child edges will be return
	 ...
	 * 
	 * @param edge
	 *            the whose terminal is being sought
	 * @param isSource
	 *            whether the source terminal is being sought
	...
	/**
	 * Returns all distinct opposite cells for the specified terminal on the given
	 * edges.
	 * 
	 * @param edges
