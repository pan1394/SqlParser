...
public class mxFastOrganicLayout extends mxGraphLayout {
	/**
	 * Specifies if the top left corner of the input cells should be the origin of
	 * the layout result. Default is true.
	 */
	...
	/**
	 * The maximum distance between vertices, beyond which their repulsion no longer
	 * has an effect
	 */
