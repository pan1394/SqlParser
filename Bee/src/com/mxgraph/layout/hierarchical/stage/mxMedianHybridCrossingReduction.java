 ...
 */
public class mxMedianHybridCrossingReduction implements mxHierarchicalLayoutStage/* , JGraphLayout.Stoppable */
{
	/**
	...
	/**
	 * Stores each rank as a collection of cells in the best order found for each
	 * layer so far
	 */
	 ...
	 * @return the current number of edge crossings in the hierarchy graph model in
	 *         the current candidate layout
	 */
	 ...
	 * connected cells on the specified rank
	 * 
