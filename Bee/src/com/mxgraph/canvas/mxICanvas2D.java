...
public interface mxICanvas2D {
	...
	/**
	 * Rotates the canvas by the given angle around the given center. This method
	 * may add rendering overhead and should be used with care.
	 * 
	 * @param theta
	 ...
	 * 
	 * @param value
	 *            Width of the stroke. The value should be multiplied by the current
	 *            scale.
	 */
	 ...
	 * 
	 * @param value
	 *            Space separated list of floats representing the dash pattern. The
	 *            value should be multiplied by the current scale.
	 */
	...
	/**
	 * Default value 1. This method may add rendering overhead and should be used
	 * with care.
	 * 
	 * @param value
	 */
	...
	/**
	 * Draws the given string. Possible values for format are empty string for plain
