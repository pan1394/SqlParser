...
public abstract class mxBasicCanvas implements mxICanvas {
	...
	/**
	 * Defines the default value for the imageBasePath in all GDI canvases. Default
	 * is an empty string.
	 */
	 ...
	 * before than an instance of the same instance is returned as in the previous
	 * call.
	 */
	...
	/**
	 * Gets the image path from the given style. If the path is relative (does not
	 * start with a slash) then it is appended to the imageBasePath.
	 */
