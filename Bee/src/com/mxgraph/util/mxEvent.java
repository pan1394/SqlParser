...
public class mxEvent {
	...
	/**
	 * Holds the name for the change event. First and only argument in the argument
	 * array is the list of mxAtomicGraphChanges that have been executed on the
	 * model.
	 */
	public static final String CHANGE = "change";

	/**
	 * Holds the name for the execute event. First and only argument in the argument
	 * array is the mxAtomicGraphChange that has been executed on the model. This
	 * event fires before the change event.
	 */
	...
	/**
	 * Holds the name for the norify event. First and only argument in the argument
	 * array is the list of mxAtomicGraphChanges that have been executed on the
	 ...
	 * First and only argument in the array is the cell state that has been marked
	 * or null, if no state has been marked.
	 * 
