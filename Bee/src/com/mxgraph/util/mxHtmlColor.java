...
public class mxHtmlColor {
	 ...
	 * All 147 CSS color names and none are also supported. None returns null.
	 * Examples of possible hex color values are: #C3D9FF, #6482B9 and #774400, but
	 * note that you do not include the "#" in the string passed in
	 * 
	 * @param str
	...
	public static Color parseColor(String str, double alpha) throws NumberFormatException {
		if (str == null || str.equals(mxConstants.NONE)) {
			...
			str = new String(new char[] { '#', str.charAt(1), str.charAt(1), str.charAt(2), str.charAt(2),
	...
	protected static Color parseRgb(String rgbString) {
		...
		return new Color(parseValue(red, 255), parseValue(green, 255), parseValue(blue, 255), parseAlpha(alpha));
	}
