 ...
 */
public class mxUndoManager extends mxEventSource implements BEditorUndo {
	 ...
	 */
	public void undoableEditHappened(Object object) {
		mxUndoableEdit undoableEdit = (mxUndoableEdit) object;
		trim();
	...
	/**
	 * Removes all pending steps after indexOfNextAdd from the history, invoking die
	 * on each edit. This is called from undoableEditHappened.
	 */
	protected void trim() {
