...
public class mxRectangle extends mxPoint {
	...
	/**
	 * Returns the point at which the specified point intersects the perimeter of
	 * this rectangle or null if there is no intersection.
	 * 
	 * @param x0
	...
	public boolean equals(Object obj) {
		if (obj instanceof mxRectangle) {
			...
			return rect.getX() == getX() && rect.getY() == getY() && rect.getWidth() == getWidth()
