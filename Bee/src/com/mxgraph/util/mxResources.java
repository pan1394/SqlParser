...
public class mxResources {
	...
	/**
	 * Adds a resource bundle. This may throw a MissingResourceException that should
	...
	/**
	 * Returns the value for <code>key</code> by searching the resource bundles in
	 * inverse order or <code>null</code> if no value can be found for
	 * <code>key</code>.
	 */
