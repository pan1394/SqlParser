...
public class mxUtils {
	...
	/**
	 * Returns the size for the given label. If isHtml is true then any HTML markup
	 * in the label is computed as HTML and all newlines inside the HTML body are
	 * converted into linebreaks.
	 */
	...
	/**
	 * Returns the bounds for a label for the given location and size, taking into
	 * account the alignment and spacing in the specified style, as well as the
	 * width and height of the rectangle that contains the label. (For edge labels
	 * this width and height is 0.) The scale is used to scale the given size and
	 * the spacings in the specified style.
	 */
	...
	/**
	 * Returns the specified text in lines that fit within the specified width when
	 * the specified font metrics are applied to the text
	 * 
	 * @param text
	 *            the text to wrap
	 * @param metrics
	...
	public static mxRectangle getSizeForHtml(String markup, Map<String, Object> style, double scale, double wrapWidth) {
		...
		if (textRenderer != null) {
			...
			if (wrapWidth > 0) {
				textRenderer.setText(createHtmlDocument(style, markup, 1, (int) Math.ceil(wrapWidth - mxConstants.LABEL_INSET * scale)));
	 ...
	 * @return the position of the first character matching the input character in
	 *         the given string where the character has no letter preceding it.
	 */
	...
	/**
	 * Creates a new list of new points obtained by translating the points in the
	 * given list by the given vector. Elements that are not mxPoints are added to
	 * the result as-is.
	 */
	...
	/**
	 * Returns the index of the given object in the given array of -1 if the object
	 ...
	 * if the given stylename does not occur (as a stylename) in the given style,
	 * otherwise it returns the index of the first character.
	 * 
	 * @deprecated Use <code>mxStyleUtils.indexOfStylename(String, String)</code>
	 *             (Jan 2012)
	 */
	 ...
	 * 
	 * @deprecated Use <code>mxStyleUtils.removeAllStylenames(String)</code> (Jan
	 *             2012)
	 */
	...
	/**
	 * Adds or removes the given key, value pair to the style and returns the new
	 * style. If value is null or zero length then the key is removed from the
	 * style.
	 * 
	 * @param style
	 ...
	 * @deprecated Use <code>mxStyleUtils.setStyle(String, String, String)</code>
	 *             (Jan 2012)
	 */
	...
	/**
	 * Sets or removes the given key from the specified style and returns the new
	 * style. If value is null then the flag is toggled.
	 * 
	 * @param style
	 *            String of the form stylename[;key=value].
	 * @param key
	...
	/**
	 * Returns true if the given coordinate pair intersects the hotspot of the given
	 * state.
	 */
	...
	/**
	 * Returns true if the dictionary contains true for the given key or false if no
	...
	/**
	 * Returns true if the dictionary contains true for the given key or the given
	...
	/**
	 * Returns the value for key in dictionary as an int or 0 if no value is defined
	 * for the key.
	 * 
	 * @param dict
	 *            Dictionary that contains the key, value pairs.
	...
	/**
	 * Returns the value for key in dictionary as an int or the given default value
	...
	/**
	 * Returns the value for key in dictionary as a float or the given default value
	 * if no value is defined for the key.
	 * 
	 * @param dict
	 *            Dictionary that contains the key, value pairs.
	...
	/**
	 * Returns the value for key in dictionary as a string or null if no value is
	 * defined for the key.
	 * 
	 * @param dict
	 *            Dictionary that contains the key, value pairs.
	...
	/**
	 * Returns the value for key in dictionary as a color or the given default value
	 * if no value is defined for the key.
	 * 
	 * @param dict
	 *            Dictionary that contains the key, value pairs.
	...
	public static Font getFont(Map<String, Object> style, double scale) {
		...
		Map<TextAttribute, Integer> fontAttributes = (fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE ? Collections.singletonMap(TextAttribute.UNDERLINE, TextAttribute.UNDERLINE_ON) : null;
	 ...
	 * The following color names are also supported: white, black, red, green, blue,
	 * orange, yellow, pink, turquoise, gray and none (null). Examples of possible
	 * hex color values are: #C3D9FF, #6482B9 and #774400, but note that you do not
	 * include the "#" in the string passed in
	 * 
	 * @param colorString
	 *            the 24/32bit hex string value (ARGB)
	 * @return java.awt.Color (24bit RGB on JDK 1.1, 24/32bit ARGB on JDK1.2)
	 * @exception NumberFormatException
	 *                if the specified string cannot be interpreted as a hexidecimal
	 *                integer
	 */
	...
	/**
	 * Convert a string representing a dash pattern into a float array. A valid dash
	 * pattern is a string of dash widths (floating point values) separated by space
	 * characters.
	 * 
	 ...
	 * @return float[]
	 * @exception NumberFormatException
	 *                if any of the dash widths cannot be interpreted as a floating
	 *                point number
	 */
	...
	/**
	 * Returns true if the user object is an XML node with the specified type and
	 * and the optional attribute has the specified value or is not specified.
	 * 
	 * @param value
	...
	/**
	 * Returns true if the given value is an XML node with the node name and if the
	 * optional attribute has the specified value.
	 * 
	 * @param value
	 *            Object that should be examined as a node.
	 * @param nodeName
	...
	/**
	 * Clears the given area of the specified graphics object with the given color
	 * or makes the region transparent.
	 */
	...
	public static BufferedImage createBufferedImage(int w, int h, Color background) {
		return mxUtils.createBufferedImage(w, h, background, (background != null) ? BufferedImage.TYPE_INT_RGB : BufferedImage.TYPE_INT_ARGB);
	}
	...
	/**
	 * Creates a table for the given text using the given document to create the DOM
	 * nodes. Returns the outermost table node.
	 */
	...
	/**
	 * Returns a new, empty DOM document. The head argument can be used to provide
	 * an optional HEAD section without the HEAD tags as follows:
	 * 
	 * <pre>
	...
	public static HTMLDocument createHtmlDocumentObject(Map<String, Object> style, double scale, int lineHeight) {
		...
		rule.append("line-height:" + lineHeight + "pt;");
	...
	/**
	 * Returns a new DOM document for the given URI. External entities and DTDs are
	 * ignored.
	 * 
	 * @param uri
	...
	/**
	 * Returns the first node where attr equals value. This implementation does not
	 * use XPath.
	 */
