 ...
 * <code>Arc2D</code> in float precision.
 *
 * <p>
 * <b>Warning</b> : An elliptical arc may be composed of several path segments.
 * For futher details, see the SVG Appendix&nbsp;F.6
 *
...
public class ExtendedGeneralPath implements Shape, Cloneable {
	 ...
	 *
	 * @param angle
	 *            the angle from the x-axis of the current coordinate system to the
	 *            x-axis of the ellipse in degrees.
	 *
	 * @param largeArcFlag
	 *            the large arc flag. If true the arc spanning less than or equal to
	 *            180 degrees is chosen, otherwise the arc spanning greater than 180
	 *            degrees is chosen
	 *
	 * @param sweepFlag
	 *            the sweep flag. If true the line joining center to arc sweeps
	 *            through decreasing angles otherwise it sweeps through increasing
	 *            angles
	 *
	 * @param x
	 ...
	 */
	public synchronized void arcTo(float rx, float ry, float angle, boolean largeArcFlag, boolean sweepFlag, float x,
			float y) {
