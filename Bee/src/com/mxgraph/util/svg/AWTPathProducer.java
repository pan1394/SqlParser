...
public class AWTPathProducer implements PathHandler, ShapeProducer {
	 ...
	 * 
	 * @param text
	 *            The text representation of the path specification.
	 * @param wr
	...
	/**
	 * Implements
	 * {@link PathHandler#curvetoCubicRel(float,float,float,float,float,float)}.
	 */
	...
	/**
	 * Implements
	 * {@link PathHandler#curvetoCubicAbs(float,float,float,float,float,float)}.
	 */
	...
	/**
	 * Implements
	 * {@link PathHandler#arcRel(float,float,float,boolean,boolean,float,float)}.
	 */
	...
	/**
	 * Implements
	 * {@link PathHandler#arcAbs(float,float,float,boolean,boolean,float,float)}.
	 */
