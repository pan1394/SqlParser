...
public class mxConstants {
	...
	/**
	 * Comma separated list of default fonts for CSS properties. And the default
	 * font family value for new image export. Default is Arial, Helvetica.
	 */
	public static String DEFAULT_FONTFAMILIES = "Arial,Helvetica";

	/**
	 * Defines the default font family. Default is "Dialog". (To be replaced with
	 * Font.DIALOG after EOL of Java 1.5.)
	 */
	...
	/**
	 * Default line height for text output. Default is 1.2. This is ignored for HTML
	 * in the current version of Java. See
	 * http://docs.oracle.com/javase/6/docs/api/index.html?javax/swing/text/html/CSS.html
	 */
	public static float LINE_HEIGHT = 1.2f;

	/**
	 * Specifies if absolute line heights should be used (px) in CSS. Default is
	 * false. Set this to true for backwards compatibility.
	 */
	...
	/**
	 * Defines the inset in absolute pixels between the label bounding box and the
	 * label text. Default is 3.
	 */
	public static int LABEL_INSET = 3;

	/**
	 * Multiplier to the width that is passed into the word wrapping calculation See
	 * mxUtils.wordWrap for details
	 */
	...
	/**
	 * Defines the color to be used to draw shadows in W3C standards. Default is
	 * gray.
	 */
	 ...
	 */
	public static float[] DEFAULT_DASHED_PATTERN = new float[] { 1.0f, 1.0f };

	/**
	 * Specifies the default distance at 1.0 scale that the label curve is created
	 * from its base curve
	 */
	...
	/**
	 * Defines the length of the horizontal segment of an Entity Relation. This can
	 * be overridden using mxConstants.STYLE_SEGMENT style. Default is 30.
	 */
	public static int ENTITY_SEGMENT = 30;

	/**
	 * Defines the rounding factor for rounded rectangles in percent between 0 and
	 * 1. Values should be smaller than 0.5. Default is 0.15.
	 */
	 ...
	 * defined in mxPerimeter that use the <code>mxPerimeterFunction</code>
	 * interface. Alternatively, the constants in this class that start with
	 * <code>PERIMETER_</code> may be used to access perimeter styles in
	 * <code>mxStyleRegistry</code>.
	 */
	public static String STYLE_PERIMETER = "perimeter";

	/**
	 * Defines the ID of the cell that should be used for computing the perimeter
	 * point of the source for an edge. This allows for graphically connecting to a
	...
	/**
	 * Defines the ID of the cell that should be used for computing the perimeter
	 * point of the target for an edge. This allows for graphically connecting to a
	 * cell while keeping the actual terminal of the edge.
	 */
	 ...
	 * "hidden" and "fill". The default value is "visible". This value specifies how
	 * overlapping vertex labels are handles. A value of "visible" will show the
	 * complete label. A value of "hidden" will clip the label so that it does not
	 * overlap the vertex bounds. A value of "fill" will use the vertex bounds for
	 * the label.
	 * 
	 ...
	 * so that the edge is vertical or horizontal if possible and if the point is
	 * not at a fixed location. Default is false. This is used in
	 * mxGraph.isOrthogonal, which also returns true if the edgeStyle of the edge is
	 * an elbow or entity.
	 */
	 ...
	 * text will never wrap to the next line until a linefeed is encountered. A
	 * value of "wrap" means text will wrap when necessary.
	 */
	...
	/**
	 * Defines the key for the fill color of the swimlane background. The value is a
	 * string expression supported by mxUtils.parseColor.
	 * 
	...
	/**
	 * Defines the key for the fillColor style. The value is a string expression
	 * supported by mxUtils.parseColor.
	 * 
	 * @see com.mxgraph.util.mxUtils#parseColor(String)
	 */
	...
	/**
	 * Defines the key for the gradientColor style. The value is a string expression
	 * supported by mxUtils.parseColor. This is ignored if no fill color is defined.
	 * 
	 * @see com.mxgraph.util.mxUtils#parseColor(String)
	 */
	 ...
	 * <code>DIRECTION_NORTH</code> and <code>DIRECTION_SOUTH</code>. Default is
	 * <code>DIRECTION_SOUTH</code>. Generally, and by default in mxGraph, gradient
	 * painting is done from the value of <code>STYLE_FILLCOLOR</code> to the value
	 * of <code>STYLE_GRADIENTCOLOR</code>. Taking the example of
	 * <code>DIRECTION_NORTH</code>, this means <code>STYLE_FILLCOLOR</code> color
	 * at the bottom of paint pattern and <code>STYLE_GRADIENTCOLOR</code> at top,
	 * with a gradient in-between.
	 */
	public static String STYLE_GRADIENT_DIRECTION = "gradientDirection";

	/**
	 * Defines the key for the strokeColor style. The value is a string expression
	 * supported by mxUtils.parseColor.
	 * 
	 * @see com.mxgraph.util.mxUtils#parseColor(String)
	 */
	 ...
	 * expression supported by mxUtils.parseColor. This style is only used for
	 ...
	 * <code>float</code> and the possible range is any non-negative value. The
	 * value reflects the stroke width in pixels.
	 */
	 ...
	 * <code>ALIGN_RIGHT</code>. This value defines how the lines of the label are
	 * horizontally aligned. <code>ALIGN_LEFT</code> mean label text lines are
	 * aligned to left of the label bounds, <code>ALIGN_RIGHT</code> to the right of
	 * the label bounds and <code>ALIGN_CENTER</code> means the center of the text
	 * lines are aligned in the center of the label bounds. Note this value doesn't
	 * affect the positioning of the overall label bounds relative to the vertex, to
	 * move the label bounds horizontally, use <code>STYLE_LABEL_POSITION</code>.
	 */
	 ...
	 * <code>ALIGN_BOTTOM</code>. This value defines how the lines of the label are
	 * vertically aligned. <code>ALIGN_TOP</code> means the topmost label text line
	 * is aligned against the top of the label bounds, <code>ALIGN_BOTTOM</code>
	 * means the bottom-most label text line is aligned against the bottom of the
	 * label bounds and <code>ALIGN_MIDDLE</code> means there is equal spacing
	 * between the topmost text label line and the top of the label bounds and the
	 * bottom-most text label line and the bottom of the label bounds. Note this
	 * value doesn't affect the positioning of the overall label bounds relative to
	 * the vertex, to move the label bounds vertically, use
	 ...
	 * <code>ALIGN_RIGHT</code>. Default is <code>ALIGN_CENTER</code>. The label
	 * align defines the position of the label relative to the cell.
	 * <code>ALIGN_LEFT</code> means the entire label bounds is placed completely
	 * just to the left of the vertex, <code>ALIGN_RIGHT</code> means adjust to the
	 * right and <code>ALIGN_CENTER</code> means the label bounds are vertically
	 * aligned with the bounds of the vertex. Note this value doesn't affect the
	 * positioning of label within the label bounds, to move the label horizontally
	 * within the label bounds, use <code>STYLE_ALIGN</code>.
	 */
	 ...
	 * are <code>ALIGN_TOP</code>, <code>ALIGN_BOTTOM</code> and
	 * <code>ALIGN_MIDDLE</code>. Default is <code>ALIGN_MIDDLE</code>. The label
	 * align defines the position of the label relative to the cell.
	 * <code>ALIGN_TOP</code> means the entire label bounds is placed completely
	 * just on the top of the vertex, <code>ALIGN_BOTTOM</code> means adjust on the
	 * bottom and <code>ALIGN_MIDDLE</code> means the label bounds are horizontally
	 * aligned with the bounds of the vertex. Note this value doesn't affect the
	 * positioning of label within the label bounds, to move the label vertically
	 * within the label bounds, use <code>STYLE_VERTICAL_ALIGN</code>.
	 */
	 ...
	 * Defines the key for the align style. Possible values are
	 * <code>ALIGN_LEFT</code>, <code>ALIGN_CENTER</code> and
	 * <code>ALIGN_RIGHT</code>. The value defines how any image in the vertex label
	 * is aligned horizontally within the label bounds of a SHAPE_LABEL shape.
	 */
	 ...
	 * mxImageBundle. The type of the value is <code>String</code>. This is the path
	 * to the image to image that is to be displayed within the label of a vertex.
	 * See mxGraphics2DCanvas.getImageForStyle, loadImage and setImageBasePath on
	 * how the image URL is resolved. Finally, mxUtils.loadImage is used for loading
	 * the image for a given value.
	 */
	public static String STYLE_IMAGE = "image";

	/**
	 * Defines the key for the imageWidth style. The type of this value is
	 * <code>int</code>, the value is the image width in pixels and must be greated
	 * than 0.
	 */
	 ...
	 * <code>int</code>, the value is the image height in pixels and must be greater
	 * than 0.
	 */
	public static String STYLE_IMAGE_HEIGHT = "imageHeight";

	/**
	 * Defines the key for the image background color. This style is only used for
	...
	/**
	 * Defines the key for the image border color. This style is only used for image
	 * shapes. Possible values are all HTML color names or HEX codes.
	 */
	 ...
	 * mxImageShape. Possible values are 0 and 1. Default is 0.
	 */
	public static String STYLE_IMAGE_FLIPH = "imageFlipH";

	/**
	 * Defines the key for the vertical image flip. This style is only used in
	 * mxImageShape. Possible values are 0 and 1. Default is 0.
	 */
	public static String STYLE_IMAGE_FLIPV = "imageFlipV";

	/**
	 * Defines the key for the horizontal stencil flip. This style is only used for
	 * <mxStencilShape>. Possible values are 0 and 1. Default is 0.
	 */
	public static String STYLE_STENCIL_FLIPH = "stencilFlipH";

	/**
	 * Defines the key for the vertical stencil flip. This style is only used for
	 * <mxStencilShape>. Possible values are 0 and 1. Default is 0.
	 */
	 ...
	 * 
	 * Defines the key for the vertical flip. Possible values are 0 and 1. Default
	 * is 0.
	 */
	 ...
	 * visible for a given cell. Possible values are true or false (1 or 0). Default
	 * is false.
	 */
	 ...
	 * is applied for a given edge. Possible values are true or false (1 or 0).
	 * Default is false.
	 */
	...
	/**
	 * Defines the key for the label border color. The value is a string expression
	 * supported by mxUtils.parseColor.
	 * 
	 * @see com.mxgraph.util.mxUtils#parseColor(String)
	 */
	...
	/**
	 * Defines the key for the indicatorShape style. Possible values are any of the
	 * SHAPE_* constants.
	 */
	public static String STYLE_INDICATOR_SHAPE = "indicatorShape";

	/**
	 * Defines the key for the indicatorImage style. Possible values are any image
	 * URL, the type of the value is <code>String</code>.
	 */
	...
	/**
	 * Defines the key for the indicatorGradientColor style. The value is a string
	 * expression supported by mxUtils.parseColor. This style is only supported in
	 * SHAPE_LABEL shapes.
	 * 
	 * @see com.mxgraph.util.mxUtils#parseColor(String)
	 */
	 ...
	 * <code>boolean</code>. This style applies to vertices and arrow style edges.
	 */
	...
	/**
	 * Defines the key for the endArrow style. Possible values are all constants in
	 * this class that start with ARROW_. This style is supported in the
	 * <code>mxConnector</code> shape.
	 */
	public static String STYLE_ENDARROW = "endArrow";

	/**
	 * Defines the key for the startArrow style. Possible values are all constants
	 * in this class that start with ARROW_. See STYLE_ENDARROW. This style is
	 ...
	 * <code>float</code> and the value represents the size of the end marker in
	 * pixels.
	 */
	 ...
	 * <code>float</code> and the value represents the size of the start marker or
	 * the size of the swimlane title region depending on the shape it is used for.
	 */
	public static String STYLE_STARTSIZE = "startSize";

	/**
	 * Defines the key for the swimlaneLine style. This style specifies whether the
	 * line between the title regio of a swimlane should be visible. Use 0 for
	 ...
	 * fill. (This style is only exported via <mxImageExport>.)
	 */
	...
	/**
	 * Defines the key for the dashed pattern style. The type of this value is
	 * <code>float[]</code> and the value specifies the dashed pattern to apply to
	 * edges drawn with this style. This style allows the user to specify a
	 * custom-defined dash pattern. This is done using a series of numbers. Dash
	 * styles are defined in terms of the length of the dash (the drawn part of the
	 * stroke) and the length of the space between the dashes. The lengths are
	 * relative to the line width: a length of "1" is equal to the line width.
	 */
	public static String STYLE_DASH_PATTERN = "dashPattern";

	/**
	 * Defines the key for the rounded style. The type of this value is
	 * <code>boolean</code>. For edges this determines whether or not joins between
	 * edges segments are smoothed to a rounded finish. For vertices that have the
	 * rectangle shape, this determines whether or not the rectangle is rounded.
	 */
	public static String STYLE_ROUNDED = "rounded";

	/**
	 * Defines the rounding factor for a rounded rectangle in percent (without the
	 * percent sign). Possible values are between 0 and 100. If this value is not
	 * specified then RECTANGLE_ROUNDING_FACTOR * 100 is used. For edges, this
	 * defines the absolute size of rounded corners in pixels. If this values is not
	 * specified then LINE_ARCSIZE is used. (This style is only exported via
	 * <mxImageExport>.) Value is "arcSize".
	 */
	public static String STYLE_ARCSIZE = "arcSize";

	/**
	 * Defines the key for the source perimeter spacing. The type of this value is
	 * <code>double</code>. This is the distance between the source connection point
	 * of an edge and the perimeter of the source vertex in pixels. This style only
	 * applies to edges.
	 */
	 ...
	 * <code>double</code>. This is the distance between the target connection point
	 * of an edge and the perimeter of the target vertex in pixels. This style only
	 * applies to edges.
	 */
	 ...
	 * this applies to all incoming edges to floating ports (edges that terminate on
	 * the perimeter of the vertex). When used in an edge style, this spacing
	 * applies to the source and target separately, if they terminate in floating
	 * ports (on the perimeter of the vertex).
	 */
	 ...
	 * added to each side of a label in a vertex (style applies to vertices only).
	 */
	 ...
	 * <code>true</code> or <code>false</code>. This value only applies to vertices.
	 * If the <code>STYLE_SHAPE</code> is <code>SHAPE_SWIMLANE</code> a value of
	 * <code>false</code> indicates that the swimlane should be drawn vertically,
	 * <code>true</code> indicates to draw it horizontally. If the shape style does
	 * not indicate that this vertex is a swimlane, this value affects only whether
	 * the label is drawn horizontally or vertically.
	 */
	 ...
	 * <code>ELBOW_HORIZONTAL</code>. This defines how the three segment orthogonal
	 * edge style leaves its terminal vertices. The vertical style leaves the
	 ...
	 * <code>String</code> and of the expression supported by mxUtils.parseColor.
	 * 
	 * @see com.mxgraph.util.mxUtils#parseColor(String)
	 */
	...
	/**
	 * Defines the key for the fontSize style (in px). The type of the value is
	 * <code>int</code>.
	 */
	 ...
	 * of FONT_BOLD, FONT_ITALIC and FONT_UNDERLINE. The type of the value is
	 * <code>int</code>.
	 */
	 ...
	 * can be edited using the in-place editor. Possible values are 0 or 1. Default
	 * is 1. See mxGraph.isCellEditable.
	 */
	public static String STYLE_EDITABLE = "editable";

	/**
	 * Defines the key for the bendable style. This specifies if the control points
	 * of an edge can be moved. Possible values are 0 or 1. Default is 1. See
	 ...
	 * Possible values are 0 or 1. Default is 1. See mxGraph.isCellMovable.
	 */
	public static String STYLE_MOVABLE = "movable";

	/**
	 * Defines the key for the resizable style. This specifies if a cell can be
	 * resized. Possible values are 0 or 1. Default is 1. See
	 * mxGraph.isCellResizable.
	 */
	public static String STYLE_RESIZABLE = "resizable";

	/**
	 * Defines the key for the cloneable style. This specifies if a cell can be
	 * cloned. Possible values are 0 or 1. Default is 1. See
	...
	/**
	 * Defines the key for the shape style. Possible values are any of the SHAPE_*
	 * constants.
	 */
	public static String STYLE_SHAPE = "shape";

	/**
	 * Takes a function that creates points. Possible values are the functions
	 ...
	 * between -0.5 and 0.5. This is the relative offset from the center used for
	 * connecting edges. The type of this value is <code>float</code>.
	 */
	 ...
	 * edges. The type of this value is <code>float</code>.
	 */
	...
	/**
	 * Name of the elbow edge style. Can be used as a string value for the
	 * STYLE_EDGE style.
	 */
	public static final String EDGESTYLE_ELBOW = "elbowEdgeStyle";

	/**
	 * Name of the entity relation edge style. Can be used as a string value for the
	 * STYLE_EDGE style.
	 */
	public static final String EDGESTYLE_ENTITY_RELATION = "entityRelationEdgeStyle";

	/**
	 * Name of the loop edge style. Can be used as a string value for the STYLE_EDGE
	 * style.
	 */
	public static final String EDGESTYLE_LOOP = "loopEdgeStyle";

	/**
	 * Name of the side to side edge style. Can be used as a string value for the
	 * STYLE_EDGE style.
	 */
	public static final String EDGESTYLE_SIDETOSIDE = "sideToSideEdgeStyle";

	/**
	 * Name of the top to bottom edge style. Can be used as a string value for the
	 * STYLE_EDGE style.
	 */
	public static final String EDGESTYLE_TOPTOBOTTOM = "topToBottomEdgeStyle";

	/**
	 * Name of the orthogonal edge style. Can be used as a string value for the
	 * STYLE_EDGE style.
	 */
	public static final String EDGESTYLE_ORTHOGONAL = "orthogonalEdgeStyle";

	/**
	 * Name of the generic segment edge style. Can be used as a string value for the
	 * STYLE_EDGE style.
	 */
	public static final String EDGESTYLE_SEGMENT = "segmentEdgeStyle";

	/**
	 * Name of the ellipse perimeter. Can be used as a string value for the
	 * STYLE_PERIMETER style.
	 */
	public static final String PERIMETER_ELLIPSE = "ellipsePerimeter";

	/**
	 * Name of the rectangle perimeter. Can be used as a string value for the
	 * STYLE_PERIMETER style.
	 */
	public static final String PERIMETER_RECTANGLE = "rectanglePerimeter";

	/**
	 * Name of the rhombus perimeter. Can be used as a string value for the
	 * STYLE_PERIMETER style.
	 */
	public static final String PERIMETER_RHOMBUS = "rhombusPerimeter";

	/**
	 * Name of the triangle perimeter. Can be used as a string value for the
	 * STYLE_PERIMETER style.
	 */
	public static final String PERIMETER_TRIANGLE = "trianglePerimeter";

	/**
	 * Name of the hexagon perimeter. Can be used as a string value for the
	 * STYLE_PERIMETER style.
	 */
