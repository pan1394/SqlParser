...
public class mxChildChangeCodec extends mxObjectCodec {
	...
	public mxChildChangeCodec() {
		this(new mxChildChange(), new String[] { "model", "child", "previousIndex" },
				new String[] { "parent", "previous" }, null);
	}
	...
	public Object afterDecode(mxCodec dec, Node node, Object obj) {
		if (obj instanceof mxChildChange) {
			...
			((mxICell) change.getChild()).setParent((mxICell) change.getPrevious());
