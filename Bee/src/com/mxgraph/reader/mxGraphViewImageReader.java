...
public class mxGraphViewImageReader extends mxGraphViewReader {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.mxgraph.reader.mxGraphViewReader#createCanvas(java.util.Hashtable)
	 */
	...
	/**
	 * Creates the image for the given display XML file. (Note: The XML file is an
	 * encoded mxGraphView, not mxGraphModel.)
	 * 
	 * @param filename
	...
	/**
	 * Creates the image for the given display XML input source. (Note: The XML is
