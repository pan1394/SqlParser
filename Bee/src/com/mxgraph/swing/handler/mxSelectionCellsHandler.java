...
public class mxSelectionCellsHandler implements MouseListener, MouseMotionListener {
	...
	/**
	 * Defines the maximum number of handlers to paint individually. Default is
	 * DEFAULT_MAX_HANDLES.
	 */
	...
	/**
	 * Dispatches the mousepressed event to the subhandles. This is called from the
	 * connection handler as subhandles have precedence over the connection handler.
	 */
	...
	/**
	 * Redirects the tooltip handling of the JComponent to the graph component,
	 * which in turn may use getHandleToolTipText in this class to find a tooltip
