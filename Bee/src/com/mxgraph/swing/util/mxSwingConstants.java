...
public class mxSwingConstants {
	...
	static {
		try {
			mxSwingConstants.EMPTY_IMAGE = new BufferedImage(1, 1, BufferedImage.TYPE_INT_RGB);
		} catch (Exception e) {
	...
	/**
	 * Defines the stroke used for painting the border of selected vertices. Default
	 * is a dashed line.
	 */
	 ...
	 */
	public static Border PREVIEW_BORDER = new LineBorder(mxSwingConstants.HANDLE_BORDERCOLOR) {
		/**
		 * 
		 */
