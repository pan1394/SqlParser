...
public class mxAnimation extends mxEventSource {
	...
	/**
	 * Hook for subclassers to implement the animation. Invoke stopAnimation when
	 * finished, startAnimation to resume. This is called whenever the timer fires
	 * and fires an mxEvent.EXECUTE event with no properties.
	 */
