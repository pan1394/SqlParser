...
public class mxCellOverlay extends JComponent implements mxICellOverlay {
	...
	/**
	 * Holds the horizontal alignment for the overlay. Default is ALIGN_RIGHT. For
	 * edges, the overlay always appears in the center of the edge.
	 */
	protected Object align = mxConstants.ALIGN_RIGHT;

	/**
	 * Holds the vertical alignment for the overlay. Default is bottom. For edges,
	 * the overlay always appears in the center of the edge.
	 */
	...
	/**
	 * @return the alignment of the overlay, see
	 *         <code>mxConstants.ALIGN_*****</code>
	 */
	...
	/**
	 * @param value
	 *            the alignment to set, see <code>mxConstants.ALIGN_*****</code>
	 */
	...
	/**
	 * @param value
	 *            the vertical alignment to set, see
	 *            <code>mxConstants.ALIGN_*****</code>
	 */
	 ...
	 * 
	 * @see
	 * com.mxgraph.swing.util.mxIOverlay#getBounds(com.mxgraph.view.mxCellState)
	 */
