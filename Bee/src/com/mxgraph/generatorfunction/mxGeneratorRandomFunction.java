...
/**
 * @author Mate A generator random cost function It will generate random (type
 *         "double") edge weights in the range of (<b>minWeight</b>,
 *         <b>maxWeight</b>) and rounds the values to <b>roundToDecimals</b>
 */
public class mxGeneratorRandomFunction extends mxGeneratorFunction {
	...
	public double getCost(mxCellState state) {
		...
		edgeWeight = (double) Math.round(edgeWeight * Math.pow(10, getRoundToDecimals()))
				/ Math.pow(10, getRoundToDecimals());
