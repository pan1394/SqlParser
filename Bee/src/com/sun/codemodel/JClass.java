...
public abstract class JClass extends JType {
	 ...
	 *         method returns "String" for {@code java.lang.String}.
	 */
	...
	/**
	 * Returns the class in which this class is nested, or {@code null} if this is a
	 * top-level class.
	 */
	public JClass outer() {
		return null;
	 ...
	 *         class is given explicitly or this {@link JClass} is not a class, this
	 *         method still returns {@link JClass} for {@link Object}. If this
	 *         JClass represents {@link Object}, return null.
	 */
	 ...
	 * 
	 * <p>
	 * For example, if this {@link JClass} represents {@code Set<T>}, this method
	...
	/**
	 * If this class represents one of the wrapper classes defined in the java.lang
	 * package, return the corresponding primitive type. Otherwise null.
	 */
	 ...
	 *             since it's always guaranteed to return {@code this}.
	 */
	...
	public final boolean isAssignableFrom(JClass derived) {
		...
		if (derived.fullName().startsWith(this.fullName()))
			return true;
	 ...
	 * @return The use of {@code baseType} in {@code this} type. or null if the type
	 *         is not assignable to the base type.
	 */
	 ...
	 * @return never null
	 */
	public static final JClass wildcard(JCodeModel cm, JClass jcalss) {
		return new JTypeWildcard(cm, jcalss);
	}
	 ...
	 * 
	 * <p>
	 * For example, when this class is {@code Map<String,Map<V>>}, (where V then
	 * doing substituteParams( V, Integer ) returns a {@link JClass} for
	 * {@code Map<String,Map<Integer>>}.
	 * 
	 * <p>
