...
public abstract class JExpressionImpl implements JExpression {
	...
	public final JExpression incrBefore() {
		return JOp.incrBefore(this);
	}

	public final JExpression decrBefore() {
		return JOp.decrBefore(this);
	}
	...
	public final JExpression shlz(JExpression right) {
		return JOp.shlz(this, right);
	}
