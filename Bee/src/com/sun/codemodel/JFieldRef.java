...
public class JFieldRef extends JExpressionImpl implements JAssignmentTarget, JStatement {
	/**
	...
	public JExpression assignPlus(JExpression rhs, String op) {
		return JExpr.assignPlus(this, rhs, op);
	}
