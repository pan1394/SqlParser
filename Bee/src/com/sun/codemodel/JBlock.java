...
public final class JBlock implements JGenerable, JStatement {
	 ...
	 *
	 * For example if the value is 0, newly created instructions will be inserted at
	...
	public JBlock assignPlus(JAssignmentTarget lhs, JExpression exp, String op) {
		insert(new JAssignment(lhs, exp, op));
		return this;
	}
	 ...
	 *
	 * @param expr
	 *            JExpression evaluating to the class or object upon which the
	 *            method will be invoked
	 *
	 * @param method
	 *            JMethod to invoke
	...
	public void _assert(JExpression exp) {
		insert(new JAssert(exp));
	}
