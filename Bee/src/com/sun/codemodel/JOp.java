...
abstract public class JOp {
	...
	static private class TightUnaryOp extends UnaryOp implements JStatement {
	...
	public static JExpression incrBefore(JExpression e) {
		return new TightUnaryOp(e, "++");
	}

	public static JExpression decrBefore(JExpression e) {
		return new TightUnaryOp(e, "--");
	}
	...
	public static JExpression shlz(JExpression left, JExpression right) {
		return new BinaryOp("<<<", left, right);
	}
